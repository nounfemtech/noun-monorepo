  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=warning]:text-yellow-600 data-[variant=warning]:focus:bg-yellow-500/10 data-[variant=warning]:focus:text-yellow-600 dark:data-[variant=warning]:text-yellow-500 dark:data-[variant=warning]:focus:bg-yellow-500/15 dark:data-[variant=warning]:focus:text-yellow-500",
