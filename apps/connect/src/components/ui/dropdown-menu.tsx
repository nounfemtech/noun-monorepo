  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=warning]:text-amber-600 data-[variant=warning]:focus:bg-amber-500/10 data-[variant=warning]:focus:text-amber-600 dark:data-[variant=warning]:text-amber-500 dark:data-[variant=warning]:focus:bg-amber-500/15 dark:data-[variant=warning]:focus:text-amber-500",
