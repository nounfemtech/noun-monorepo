// Formatadores de documentos profissionais de saude (CRM, RQE, CRP, CRN, CRF).
// Fonte compartilhada do monorepo: usados em apps/admin (tenants) e apps/connect
// (perfil do medico, futuramente receitas). apps/admin/src/lib/formatters.ts
// re-exporta daqui.
